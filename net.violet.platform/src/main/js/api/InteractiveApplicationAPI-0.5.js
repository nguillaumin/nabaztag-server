...
Object.complete(String.prototype, {
	...
	replaceTemplateVariables: function(replacements) {
		...
		if (typeof replacements == "object") {
			...
			if (replacements.constructor !== Array) replacements = [replacements];
...
//----------------------------------------------------------------------------80
	...
	Object.extend(Settings.prototype, {
		getString: function(key, defaultValue) {
			var s = this[key];
			if (!s) return (defaultValue !== undefined) ? defaultValue : null;
			return String(s);
		},
