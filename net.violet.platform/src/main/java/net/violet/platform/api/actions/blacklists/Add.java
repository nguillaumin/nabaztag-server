...
public class Add extends AbstractAction {
	...
	protected Object doProcessRequest(ActionParam inParam) throws ForbiddenException, InvalidSessionException, InvalidParameterException, NoSuchPersonException {
		...
		if (blackedUser.getId() == theUser.getId()) {
			throw new InvalidParameterException(APIErrorMessage.BLACKING_ITSELF, StringShop.EMPTY_STRING);
		}

		BlackData.addToBlackList(theUser, blackedUser);
