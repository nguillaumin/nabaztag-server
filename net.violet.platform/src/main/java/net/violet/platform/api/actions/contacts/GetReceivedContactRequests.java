...
public class GetReceivedContactRequests extends AbstractContactAction {
	...
	protected Object doProcessRequest(ActionParam inParam) throws ForbiddenException, InvalidSessionException, InvalidParameterException {
		...
		for (final ContactData theContactData : ContactData.getReceivedContactRequest(theSessionUser, skip, count)) {
