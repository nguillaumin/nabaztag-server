...
import net.violet.platform.api.maps.NotificationInformationMap;
import net.violet.platform.datamodel.Application;
import net.violet.platform.datamodel.Application.ApplicationClass;
import net.violet.platform.dataobjects.NotificationData;
import net.violet.platform.dataobjects.VObjectData;

public class GetReceived extends AbstractObjectAction {
	...
	protected Object doProcessRequest(ActionParam inParam) throws InvalidParameterException, NoSuchObjectException, ForbiddenException, InvalidSessionException {
		...
		final List<NotificationInformationMap> resultList = new LinkedList<NotificationInformationMap>();
		for (final NotificationData theNotification : NotificationData.getReceived(theObject, skip, count)) {
			resultList.add(new NotificationInformationMap(inParam.getCaller(), theNotification));
		}
		return resultList;
	}
