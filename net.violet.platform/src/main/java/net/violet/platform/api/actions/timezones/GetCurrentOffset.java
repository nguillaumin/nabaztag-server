...
public class GetCurrentOffset extends AbstractAction {

	@Override
	protected Object doProcessRequest(ActionParam inParam) throws InvalidParameterException {

		final String javaTimeZoneID = inParam.getMainParamAsString();
		return TimezoneData.getCurrentOffset(javaTimeZoneID);
	}
