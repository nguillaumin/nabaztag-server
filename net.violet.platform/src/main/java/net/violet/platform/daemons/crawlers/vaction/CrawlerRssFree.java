...
public class CrawlerRssFree extends AbstractVActionCrawler<TTSProcessUnit> {
	...
	public CrawlerRssFree(String[] inArgs) {
		...
		this.mProcessor = new FeedCrawlerTTSProcessor(Constantes.MAX_PROCESSING_ITEMS_TTS, getService().getLabel() + "-" + SERVICE_ACCESSRIGHT.FREE.toString());
	}
