 ...
 */
public class FrequencySchedulerTest extends MockTestBase {
	...
	public void oneOutOfThreeOverWindow() {
		...
		final Application theApplication = Factories.APPLICATION.findByName("net.violet.rss.actustar");
		...
		final Subscription theSubscription = Factories.SUBSCRIPTION.findByApplicationAndObject(theApplication, getBrewsterObject()).get(0);
	...
	public void over2DaysAgain() {
		...
		Factories.SUBSCRIPTION_SCHEDULING_SETTINGS.create(scheduling, FrequencyHandler.FREQUENCY, FrequencyHandler.Frequency.VERY_OFTEN.getLabel());
		Factories.SUBSCRIPTION_SCHEDULING_SETTINGS.create(scheduling, FrequencyHandler.LAST_TIME, lastTime.getTimestampUTC());
