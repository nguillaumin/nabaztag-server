...
INSERT INTO `application_setting` (id, application_id, `key`, `value`) values(1, 1, 'key1', 'value1');
INSERT INTO `application_setting` (id, application_id, `key`, `value`) values(2, 1, 'key2', 'value2');
