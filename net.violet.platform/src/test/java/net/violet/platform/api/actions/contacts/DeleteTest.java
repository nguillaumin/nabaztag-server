...
public class DeleteTest extends AbstractTestBase {
	...
	public void testDelete() throws APIException {
		...
		final String userId = UserData.getData(getKowalskyUser()).getApiId(caller);
		...
		Assert.assertFalse(ContactData.getContactByUserAndContact(UserData.getData(getPrivateUser()), UserData.getData(getKowalskyUser())).isValid());
	}

	@Test(expected = InvalidParameterException.class)
	public void testDeleteUserNotInContact() throws APIException {
		final Date now = new Date();
