...
public class RejectRequestTest extends AbstractTestBase {

	@Test
	public void testReject() throws APIException {
		...
		final User theUser2 = new UserMock(2, "blabla2", "12345", "test3@violet.net", getFrLang(), "France", "firstName", "lastName", getParisTimezone(), Annu.MALE, "75011", "Paris", 0);
		final User theUser3 = new UserMock(3, "blabla3", "12345", "test4@violet.net", getFrLang(), "France", "firstName", "lastName", getParisTimezone(), Annu.MALE, "75011", "Paris", 0);
		...
		final Action theAction = new RejectRequest();
		...
		final ContactData theContactData = ContactData.getContactByUserAndContact(UserData.getData(theUser1), UserData.getData(getPrivateUser()));
	...
	@Test
	public void testRejectLater() throws APIException {
		final Date now = new Date();
	...
	public void testRejectInvalidContact() throws APIException {
		final Date now = new Date();
