...
public class GetTTSLanguagesTest extends AbstractTestBase {

	@Test
	public void testGetTTSLanguages() throws APIException {

		final Action theAction = new GetTTSLanguages();
		...
		Assert.assertEquals(theList.size(), 36);
	}
}
