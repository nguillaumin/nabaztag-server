...
public final class privacy_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 response.setContentType("text/html;charset=UTF-8"); 
	...
	Lang dico_lang =	SessionTools.getLangFromSession(session, request);
      ...
      _jspx_th_logic_equal_0.setName("myTerrierPriveForm");
      ...
      _jspx_th_html_form_0.setAction("action/myTerrierPrive");
      _jspx_th_html_form_0.setStyleId("form_privacy");
      ...
      if (_jspx_eval_html_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.print(DicoTools.dico(dico_lang, "myTerrier/preferences_privacy_title"));
          ...
          if (_jspx_meth_html_checkbox_0(_jspx_th_html_form_0, _jspx_page_context))
            return;
          out.write("\r\n\t\t\t\t\t\t");
          out.print(DicoTools.dico(dico_lang, "myTerrier/preferences_privacy_authorize_add"));
          out.write("\r\n\t\t\t\t\t</label>\r\n\t\t\t\t</div>\r\n\t\r\n\t\t\t\t<div class=\"form-line\">\r\n\t\t\t\t\t<label>\t\t\t\t\t\r\n\t\t\t\t\t\t");
          if (_jspx_meth_html_checkbox_1(_jspx_th_html_form_0, _jspx_page_context))
            return;
          out.write("\r\n\t\t\t\t\t\t");
          out.print(DicoTools.dico(dico_lang, "myTerrier/preferences_privacy_notify_add"));
          out.write("\r\n\t\t\t\t\t</label>\r\n\t\t\t\t</div>\r\n\t\t\t\t\r\n\t\t\t\t<div class=\"form-line\">\r\n\t\t\t\t\t<label>\t\t\t\t\t\r\n\t\t\t\t\t\t");
          if (_jspx_meth_html_checkbox_2(_jspx_th_html_form_0, _jspx_page_context))
            return;
          out.write("\r\n\t\t\t\t\t\t");
          out.print(DicoTools.dico(dico_lang, "myTerrier/preferences_only_friends"));
  ...
  private boolean _jspx_meth_html_hidden_0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_0.setName("myTerrierPriveForm");
  ...
  private boolean _jspx_meth_html_hidden_1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_1.setName("myTerrierPriveForm");
    _jspx_th_html_hidden_1.setProperty("queFaire");
    _jspx_th_html_hidden_1.setValue("prive");
  ...
  private boolean _jspx_meth_html_checkbox_0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_checkbox_0.setName("myTerrierPriveForm");
    _jspx_th_html_checkbox_0.setProperty("authorisation");
  ...
  private boolean _jspx_meth_html_checkbox_1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_checkbox_1.setName("myTerrierPriveForm");
    _jspx_th_html_checkbox_1.setProperty("notification");
    _jspx_th_html_checkbox_1.setValue("2");
  ...
  private boolean _jspx_meth_html_checkbox_2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_checkbox_2.setStyleId("f1");
    _jspx_th_html_checkbox_2.setName("myTerrierPriveForm");
    _jspx_th_html_checkbox_2.setProperty("filtre");
