...
public final class inc_005freveil_005ffree_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 response.setContentType("text/html;charset=UTF-8"); 
	...
	Lang dico_lang = SessionTools.getLangFromSession(session, request);
      ...
      _jspx_th_bean_define_0.setName("mySrvReveilFreeForm");
      ...
      _jspx_th_html_form_0.setAction("/action/srvReveilFreeConfig");
      ...
      if (_jspx_eval_html_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          _jspx_th_bean_define_1.setName("mySrvReveilFreeForm");
          _jspx_th_bean_define_1.setProperty("horraire");
          _jspx_th_bean_define_1.setId("heures");
          ...
          _jspx_th_bean_define_2.setName("mySrvReveilFreeForm");
          _jspx_th_bean_define_2.setProperty("sonNom");
          _jspx_th_bean_define_2.setId("sonNom");
          ...
          _jspx_tagPool_bean_define_property_name_id_nobody.reuse(_jspx_th_bean_define_2);
          java.lang.Object sonNom = null;
          sonNom = (java.lang.Object) _jspx_page_context.findAttribute("sonNom");
          out.write("\r\n\t\t\t");
          //  bean:define
          ...
          _jspx_th_bean_define_3.setName("mySrvReveilFreeForm");
          _jspx_th_bean_define_3.setProperty("music_id");
          _jspx_th_bean_define_3.setId("musicId");
          ...
          out.write("\t\t\t\t\r\n\n\t\t\t<label>");
          out.print(DicoTools.dico(dico_lang , "srv_reveil/choose_sound"));
          out.write("</label>\r\n\t\t\t<input name=\"music_id\" id=\"son\" type='hidden' class='songPicker'  title=\"");
          out.print(sonNom);
          out.write("\" value=\"");
          out.print(musicId);
          out.write("\"/>\r\n\t\t\r\n\t\t\t<hr class=\"spacer\">\r\n\t\t\t\t\t\r\n\t\t\t<label>");
          out.print(DicoTools.dico(dico_lang , "srv_reveil/choose_time"));
