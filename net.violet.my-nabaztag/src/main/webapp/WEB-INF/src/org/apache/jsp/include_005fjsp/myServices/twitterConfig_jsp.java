...
public final class twitterConfig_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 response.setContentType("text/html;charset=UTF-8");
	...
	Lang dico_lang = SessionTools.getLangFromSession(session, request);
      ...
      _jspx_th_html_form_0.setAction("/action/srvTwitterConfig");
      _jspx_th_html_form_0.setStyleId("srvTwitterConfig");
      _jspx_th_html_form_0.setStyleClass("srvConfigForm");
      int _jspx_eval_html_form_0 = _jspx_th_html_form_0.doStartTag();
      if (_jspx_eval_html_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n\r\n\t\t\t\t<div>\r\n\t\t\t\t\t<label>");
          out.print(DicoTools.dico(dico_lang , "srv_twitter/login"));
          ...
          if (_jspx_meth_bean_write_0(_jspx_th_html_form_0, _jspx_page_context))
            return;
          out.write("\" />\r\n\t\t\t\t</div>\r\n\t\t\t\t\t\t\r\n\t\t\t\t<hr class=\"spacer\">\r\n\t\t\t\t\r\n\t\t\t\t<div>\n\t\t\t\t\t<label>");
          out.print(DicoTools.dico(dico_lang , "srv_twitter/password"));
          ...
          _jspx_th_html_select_0.setProperty("twitterLang");
          ...
          if (_jspx_eval_html_select_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jspx_th_logic_iterate_0.setName("mySrvTwitterForm");
          ...
          _jspx_th_logic_notEmpty_0.setName("mySrvTwitterForm");
          ...
          _jspx_th_logic_empty_0.setName("mySrvTwitterForm");
  ...
  private boolean _jspx_meth_bean_write_0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_bean_write_0.setName("mySrvTwitterForm");
  ...
  private boolean _jspx_meth_bean_write_1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_bean_write_1.setName("mySrvTwitterForm");
