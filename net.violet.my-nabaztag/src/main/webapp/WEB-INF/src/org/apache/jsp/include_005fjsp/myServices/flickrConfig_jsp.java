...
public final class flickrConfig_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 response.setContentType("text/html;charset=UTF-8");
	...
	Lang dico_lang = SessionTools.getLangFromSession(session, request);
      ...
      if (_jspx_eval_logic_messagesPresent_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n\t\t<li class=\"error\">");
          out.print(DicoTools.dico(dico_lang , "srv_flickr/bad_login"));
          out.write(' ');
      ...
      if (_jspx_eval_logic_messagesPresent_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n\t\t<li class=\"error\">");
          out.print(DicoTools.dico(dico_lang , "srv_podcast/scenario_owned"));
          out.write(' ');
      ...
      if (_jspx_eval_logic_messagesPresent_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write(" \r\n\t\t<li class=\"error\">");
          out.print(DicoTools.dico(dico_lang , "srv_flickr/not_updated"));
          out.write(' ');
      ...
      if (_jspx_eval_logic_messagesPresent_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write(" \r\n\t\t<li class=\"error\">");
          out.print(DicoTools.dico(dico_lang , "srv_podcast/scenario_not_deleted"));
          out.write(' ');
      ...
      if (_jspx_eval_logic_messagesPresent_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write(" \r\n\t\t<li class=\"error\">");
          out.print(DicoTools.dico(dico_lang , "srv_podcast/scenario_not_created"));
          out.write(' ');
      ...
      _jspx_th_html_form_0.setAction("/action/srvFlickrConfig");
      _jspx_th_html_form_0.setStyleId("srvFlickrConfig");
      _jspx_th_html_form_0.setStyleClass("srvConfigForm");
      int _jspx_eval_html_form_0 = _jspx_th_html_form_0.doStartTag();
      if (_jspx_eval_html_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n\r\n\t\t\t\t<div>\r\n\t\t\t\t\t<label>");
          out.print(DicoTools.dico(dico_lang , "srv_flickr/login"));
          ...
          _jspx_th_html_select_0.setProperty("flickrLang");
          ...
          if (_jspx_eval_html_select_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jspx_th_logic_iterate_0.setName("mySrvFlickrForm");
          ...
          _jspx_th_logic_notEmpty_0.setName("mySrvFlickrForm");
          ...
          _jspx_th_logic_empty_0.setName("mySrvFlickrForm");
  ...
  private boolean _jspx_meth_bean_write_0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_bean_write_0.setName("mySrvFlickrForm");
