...
public final class nathanSelection_jsp extends org.apache.jasper.runtime.HttpJspBase
        ...
        do {
          ...
          if (_jspx_eval_logic_notEqual_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              _jspx_th_bean_define_10.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_logic_notEqual_1);
              ...
              out.write("\n\t\t\t\t\t\t<div class=\"item-tools\"><a href=\"#js;\" onclick=\"loadPersoPlayer('");
              out.print(preview);
 ...
 String resp = DicoTools.dico(dico_lang, "srv_nathan/nabthem_ok" );
      ...
      out.print(DicoTools.dico(dico_lang , "srv_nathan/remove_from_selection"));
      out.write("\" onclick=\"page.postAjax('selectionForm', 'main-config-bloc'); return false;\"/>\n\t\t\t</div>\n\t\t</div>\n\t\t</form>\n\t</div>\n\n</div>\t");
    } catch (Throwable t) {
