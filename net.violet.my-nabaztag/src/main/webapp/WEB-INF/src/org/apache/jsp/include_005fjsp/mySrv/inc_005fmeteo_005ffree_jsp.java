...
public final class inc_005fmeteo_005ffree_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_html_radio_value_property_name;
  ...
  public void _jspInit() {
    ...
    _jspx_tagPool_html_radio_value_property_name = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    ...
    _jspx_tagPool_html_radio_value_property_name.release();
 ...
 response.setContentType("text/html;charset=UTF-8"); 
	...
	Lang dico_lang = SessionTools.getLangFromSession(session, request);
      ...
      _jspx_th_bean_define_0.setName("mySrvMeteoFreeForm");
      ...
      _jspx_th_bean_define_1.setName("mySrvMeteoFreeForm");
      ...
      _jspx_th_html_form_0.setAction("/action/srvMeteoFreeConfig");
      _jspx_th_html_form_0.setStyleId("srvMeteoFreeConfig");
      ...
      if (_jspx_eval_html_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          _jspx_th_bean_define_2.setName("mySrvMeteoFreeForm");
          ...
          _jspx_th_bean_define_3.setName("mySrvMeteoFreeForm");
          ...
          out.print(DicoTools.dico(dico_lang , "srv_weather/choose_city"));
          out.write("\r\n\t\t\t\t\t\t\t</th>\r\n\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t");
          //  html:select
          ...
          _jspx_th_html_select_0.setName("mySrvMeteoFreeForm");
          _jspx_th_html_select_0.setProperty("idVille");
          _jspx_th_html_select_0.setStyleId("idVille");
          ...
          if (_jspx_eval_html_select_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              out.write("\r\n\t\t\t\t\t\t\t\t\t<option value=\"\">");
              out.print(DicoTools.dico(dico_lang , "generic/choose_country"));
              out.write("</option>\n\t\t\t\t\t\t\t\t\t<!--  SourceData -->\r\n\t\t\t\t\t\t\t\t\t");
          ...
          _jspx_tagPool_html_select_styleId_style_property_name.reuse(_jspx_th_html_select_0);
          out.write("\r\n\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<th>\r\n\t\t\t\t\t\t\t\t");
          out.print(DicoTools.dico(dico_lang , "srv_weather/typedeg"));
          out.write("\r\n\t\t\t\t\t\t\t</th>\r\n\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t");
          //  html:radio
          org.apache.struts.taglib.html.RadioTag _jspx_th_html_radio_0 = (org.apache.struts.taglib.html.RadioTag) _jspx_tagPool_html_radio_value_property_name.get(org.apache.struts.taglib.html.RadioTag.class);
          ...
          _jspx_th_html_radio_0.setName("mySrvMeteoFreeForm");
          _jspx_th_html_radio_0.setProperty("typedeg");
          ...
          if (_jspx_eval_html_radio_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              out.print(DicoTools.dico(dico_lang , "srv_weather/degres"));
          ...
          if (_jspx_th_html_radio_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            _jspx_tagPool_html_radio_value_property_name.reuse(_jspx_th_html_radio_0);
            return;
          }
          _jspx_tagPool_html_radio_value_property_name.reuse(_jspx_th_html_radio_0);
          out.write("\r\n\t\t\t\t\t\t\t\t");
          //  html:radio
          org.apache.struts.taglib.html.RadioTag _jspx_th_html_radio_1 = (org.apache.struts.taglib.html.RadioTag) _jspx_tagPool_html_radio_value_property_name.get(org.apache.struts.taglib.html.RadioTag.class);
          ...
          _jspx_th_html_radio_1.setName("mySrvMeteoFreeForm");
          _jspx_th_html_radio_1.setProperty("typedeg");
          ...
          if (_jspx_eval_html_radio_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              out.print(DicoTools.dico(dico_lang , "srv_weather/farenheit"));
          ...
          if (_jspx_th_html_radio_1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            _jspx_tagPool_html_radio_value_property_name.reuse(_jspx_th_html_radio_1);
            return;
          }
          _jspx_tagPool_html_radio_value_property_name.reuse(_jspx_th_html_radio_1);
          out.write("\r\n\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t</tr>\r\n\r\n\t\t\t\t\t\t<tr class=\"flash\">\r\n\t\t\t\t\t\t\t<th>\r\n\t\t\t\t\t\t\t\t");
          ...
          out.print(DicoTools.dico(dico_lang , "srv_weather/language"));
          out.write("\r\n\t\r\n\t\t\t\t\t\t\t\t\t\t\t");
          //  html:select
          ...
          _jspx_th_html_select_1.setName("mySrvMeteoFreeForm");
          ...
          if (_jspx_eval_html_select_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jspx_th_logic_iterate_0.setName("mySrvMeteoFreeForm");
              ...
              if (_jspx_eval_logic_iterate_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  _jspx_th_bean_define_5.setProperty("lang_id");
                  _jspx_th_bean_define_5.setId("lang_id");
                  ...
                  _jspx_th_bean_define_6.setProperty("lang_title");
                  _jspx_th_bean_define_6.setId("lang_title");
                  ...
                  _jspx_th_bean_define_7.setProperty("lang_type");
                  _jspx_th_bean_define_7.setId("lang_type");
          ...
          _jspx_tagPool_html_select_style_property_name.reuse(_jspx_th_html_select_1);
          out.write("\r\n\r\n\t\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\r\n\t\t\t\t\t\t<tr class=\"lights\">\r\n\t\t\t\t\t\t\t<th>\r\n\t\t\t\t\t\t\t\t");
          out.print(DicoTools.dico(dico_lang , "srv_weather/light_language"));
          out.write("\r\n\t\t\t\t\t\t\t</th>\r\n\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t");
          ...
          out.print(DicoTools.dico(dico_lang , "srv_meteo_free/vocal"));
          out.write("</span> ");
...
/* Creation */
          ...
          if (_jspx_eval_logic_equal_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              _jspx_th_html_submit_0.setValue(DicoTools.dico(dico_lang , "srv_weather/add"));
              ...
              if (_jspx_eval_html_submit_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  out.print(DicoTools.dico(dico_lang , "srv_weather/add"));
...
/* Supression */
              ...
              _jspx_th_html_button_0.setValue(DicoTools.dico(dico_lang , "srv_weather/deactivate"));
              ...
              if (_jspx_eval_html_button_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  out.print(DicoTools.dico(dico_lang , "srv_weather/deactivate"));
...
/* Mise a jour */
              ...
              _jspx_th_html_submit_1.setValue(DicoTools.dico(dico_lang , "srv_weather/modify"));
              ...
              if (_jspx_eval_html_submit_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  out.print(DicoTools.dico(dico_lang , "srv_weather/modify"));
  ...
  private boolean _jspx_meth_html_hidden_0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_0.setName("mySrvMeteoFreeForm");
  ...
  private boolean _jspx_meth_html_optionsCollection_0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_select_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_optionsCollection_0.setName("mySrvMeteoFreeForm");
    _jspx_th_html_optionsCollection_0.setProperty("villeList");
    _jspx_th_html_optionsCollection_0.setLabel("label");
    _jspx_th_html_optionsCollection_0.setValue("source_path");
  ...
  private boolean _jspx_meth_html_checkbox_0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_checkbox_0.setName("mySrvMeteoFreeForm");
    _jspx_th_html_checkbox_0.setProperty("lumiere");
    _jspx_th_html_checkbox_0.setValue("1");
    _jspx_th_html_checkbox_0.setStyleId("fl");
